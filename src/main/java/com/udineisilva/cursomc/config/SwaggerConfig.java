...
/**
 * Essa classe utiliza o swagger para gerar documentação da API automaticamente
 * a partir do projeto. Automatiza o processo de geração e atualização da
 * documentação. acessar o no caminho http:localhost/<portaApp>/swagger-ui.html
 * 
 */
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				.useDefaultResponseMessages(false) // desabilitando as respostas padrao, abaixo implementado as novas
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.udineisilva.cursomc.resources"))
				.paths(PathSelectors.any()) // rastrei todos caminhos do pacote acima
				.build()
				.apiInfo(apiInfo());
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do curso Spring Boot",
				...
				new Contact("Udinei Silva",	"udemy.com/user/udinei-silva", "udineisilva@gmail.com"),
				"Permitido para estudo e consultas",
				"https://www.udemy.com/terms",
